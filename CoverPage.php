...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <link href="Cover%20Template%20for%20Bootstrap_files/ie10-viewport-bug-workaround.css" rel="stylesheet">
    ...
    <script src="Cover%20Template%20for%20Bootstrap_files/ie-emulation-modes-warning.js"></script>
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h3 class="masthead-brand">Project Selector</h3>
              <nav>
          ...
          <div class="inner cover">
            ...
            <p class="lead">
              Project Selector makes you able to select your project from
              the Internet with all your data pre-computed and projects'
              auto-selection is done automatically.
            </p>
            <p class="lead">
              <a href="Signin.php" class="btn btn-lg btn-default">Sign In</a>
            </p>
          </div>
